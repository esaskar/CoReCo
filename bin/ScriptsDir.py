...
BlastDustDir = config["blast_dust_dir"]   # "Tools/ncbi-blast-2.2.30+/db/"   #Needs to be set the user#

###     Blast Toolkit      ####################################################

IprscanDir   = config["iprscan_dir"]      # "Tools/iprscan/bin/"
Java_PATH    = config["java_path"]        # "/usr/java/latest/bin/"
LibSBML_PATH = config["libsbml_path"]     # "/share/apps/local/lib64/python2.6/site-packages/"

fastaSplitNDir = config["fastasplitn_dir"]  # "Path to the program to cut the fasta file in pieces called fastasplitN (Author: David Mathog, Biology Division, Caltech)"
