...
class MetabolicReconstructionPipeline_CreateSBML:
    ...
    def initialize(self, boundsFile, exchangeFile, pathwayFile, rxnNamesFile, modelTrainingModelDir, intAaccept, intReject, keggDataDir, ec2rxnFile, taxonomy, networkReconstructionOrgList):
    ...
    def doCreateSBML(self):
		...
		call = "bash " +  ScriptsDir.ReconstructionScripts_reco_dir_postprocess_cluster + " " + self.modelTrainingModelDir + " " + intAccept2 + " " + intReject2 + " " + organismID  + " " + ScriptsDir.ReconstructionScripts +  " " +  self.keggDataDir  + " " + self.taxonomy  + " " + self.bounds + " " + self.ec2rxnFile + " " + self.exchangeFile  + " " + " " + self.rxnNamesFile + " " + self.pathwayFile
