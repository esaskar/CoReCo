...
class MetabolicReconstructionPipeline_ClusterCreateSBML(MetabolicReconstructionPipeline_CreateSBML.MetabolicReconstructionPipeline_CreateSBML):
    ...
    def doCreateSBML(self):
		...
		call = "qsub -t 1-1 " +  ScriptsDir.ReconstructionScripts_reco_dir_postprocess_cluster + " " + self.modelTrainingModelDir + " " + intAccept2 + " " + intReject2 + " " + organismID  + " " + ScriptsDir.ReconstructionScripts +  " " +  self.keggDataDir  + " " + self.taxonomy  + " " + self.bounds + " " + self.ec2rxnFile   + " " + "3" + " " + self.rxnNamesFile + " " + self.pathwayFile 
